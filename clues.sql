...
-- TODO: Write SQL query here
SELECT * FROM city INNER JOIN country ON city.id = country.capital WHERE city.countrycode = 'BRA';
...
-- TODO: Write SQL query here
SELECT * FROM city JOIN country ON country.code = city.countrycode WHERE city.population = '91084';